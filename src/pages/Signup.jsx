          ...
          <div className="max-w-xl lg:max-w-3xl">
            ...
            <form action="#" className="mt-8 grid grid-cols-6 gap-6">
              ...
              <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
                <button className="inline-block px-12 py-3 text-sm font-medium text-white bg-blue-600 border border-blue-600 transition rounded-md shrink-0 hover:bg-transparent hover:text-blue-600 focus:outline-none focus:ring active:text-blue-500">
                  Create account
                </button>
                ...
                <p className="mt-4 text-sm text-gray-500 sm:mt-0">
                  ...
                  <a
                    className="inline-block px-6 py-3 ml-3 text-sm font-medium text-white bg-blue-600 border border-blue-600 transition rounded-md shrink-0 hover:bg-transparent hover:text-blue-600 focus:outline-none focus:ring active:text-blue-500"
                    href="/Login"
                  >
                    Login
                  </a>
