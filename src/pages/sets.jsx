...
export default function Sets() {
  return (
    <div>
      <Nav />
      <Header />
      <div className="max-w-screen-xl my-12 mx-auto flex h-96 items-center justify-center rounded-lg border-4 border-dashed border-gray-200">
      ...
      <div className="max-w-screen-xl mx-auto flex justify-between border-t border-t-neutral-200 py-2 text-sm font-medium text-gray-500">
